...
// Package graphql provides a GraphQL interface to Beats node data.
package graphql
...
// Account represents an Beats account at a particular block.
type Account struct {
...
// Transaction represents an Beats transaction.
...
// Block represents an Beats block.
...
type CallData struct {
	From                 *common.Address // The Beats address the call is from.
	To                   *common.Address // The Beats address the call is to.
