...
import (
	...
	"github.com/Blockchaindevscol/beatschain/internal/jsre/deps"
	"github.com/Blockchaindevscol/beatschain/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Beats requests through
...
// Welcome show summary of current gbeatsinstance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the gbeatsJavaScript console!\n\n"

	// Print some generic gbeatsmetadata
