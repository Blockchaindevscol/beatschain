...
// all blocks' seal as valid, though they still have to conform to the beats
// consensus rules.
...
// still have to conform to the beats consensus rules.
...
// they still have to conform to the beats consensus rules.
