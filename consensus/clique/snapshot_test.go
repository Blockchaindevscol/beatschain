...
// mapped from textual names used in the tests below to actual Beats private
...
// address retrieves the Beats address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Beats address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/Blockchaindevscol/beatschain/issues/17593). Whilst this
