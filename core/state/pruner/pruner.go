...
pruning. Remember don't start the gbeatswithout deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gbeats snapshot prune-state --help" for more details.
`
