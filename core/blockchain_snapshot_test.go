...
// It can be used for testing that restart gbeatsnormally.
...
// It can be used for testing that restart gbeatsafter the crash.
...
// Tests a gbeatsrestart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a gbeatswas crashed and restarts with a broken snapshot. In this case the
...
// Tests a gbeatswas crashed and restarts with a broken snapshot. In this case
...
// Tests a gbeatswas running with snapshot enabled. Then restarts without
...
// Tests the gbeatswas running with snapshot enabled and resetHead is applied.
...
// Tests the gbeatswas running with a complete snapshot and then imports a few
