...
import (
	...
	"github.com/Blockchaindevscol/beatschain/accounts/abi"
	"github.com/Blockchaindevscol/beatschain/accounts/keystore"
	"github.com/Blockchaindevscol/beatschain/accounts/scwallet"
	"github.com/Blockchaindevscol/beatschain/common"
	"github.com/Blockchaindevscol/beatschain/common/hexutil"
	"github.com/Blockchaindevscol/beatschain/common/math"
	"github.com/Blockchaindevscol/beatschain/consensus/clique"
	"github.com/Blockchaindevscol/beatschain/consensus/ethash"
	"github.com/Blockchaindevscol/beatschain/consensus/misc"
	"github.com/Blockchaindevscol/beatschain/core"
	"github.com/Blockchaindevscol/beatschain/core/state"
...
// PublicEthereumAPI provides an API to access beats related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new beats protocol API.
...
// Sign calculates an beats ECDSA signature for:
...
//
// https://github.com/Blockchaindevscol/beatschain/wiki/Management-APIs#personal_sign
...
//
// https://github.com/Blockchaindevscol/beatschain/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != crypto.SignatureLength {
		return common.Address{}, fmt.Errorf("signature must be %d bytes long", crypto.SignatureLength)
	}
	if sig[crypto.RecoveryIDOffset] != 27 && sig[crypto.RecoveryIDOffset] != 28 {
		return common.Address{}, fmt.Errorf("invalid beats signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and gbeats.
...
// PublicBlockChainAPI provides an API to access the beats blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new beats blockchain API.
func NewPublicBlockChainAPI(b Backend) *PublicBlockChainAPI {
	return &PublicBlockChainAPI{b}
}

// ChainId is the EIP-155 replay-protection chain id for the current beats chain config.
...
// PublicDebugAPI is the collection of beats APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of beats APIs exposed over the private
// debugging endpoint.
...
// Version returns the current beats protocol version.
