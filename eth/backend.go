...
import (
	...
	"github.com/Blockchaindevscol/beatschain/core/bloombits"
	"github.com/Blockchaindevscol/beatschain/core/rawdb"
	"github.com/Blockchaindevscol/beatschain/core/state/pruner"
	...
	"github.com/Blockchaindevscol/beatschain/eth/filters"
	"github.com/Blockchaindevscol/beatschain/eth/gasprice"
	"github.com/Blockchaindevscol/beatschain/eth/protocols/eth"
	...
	"github.com/Blockchaindevscol/beatschain/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*beats, error) {
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, gbeats%s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
