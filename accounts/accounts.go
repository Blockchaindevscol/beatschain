...
// Package accounts implements high level Beats account management.
package accounts
...
// Account represents an Beats account located at a specific location defined
