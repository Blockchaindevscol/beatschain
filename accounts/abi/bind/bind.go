...
// Package bind generates beats contract Go bindings.
//
// Detailed usage document and tutorial available on the go-beats Wiki page:
// https://github.com/Blockchaindevscol/beatschain/wiki/Native-DApps:-Go-bindings-to-beats-contracts
package bind
