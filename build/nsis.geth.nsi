...
# 1. install gbeats for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gbeats
# 5. create gbeats, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since gbeats is installed global
