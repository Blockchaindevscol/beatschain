...
import (
	...
	"github.com/Blockchaindevscol/beatschain/accounts/external"
	"github.com/Blockchaindevscol/beatschain/accounts/keystore"
	"github.com/Blockchaindevscol/beatschain/accounts/scwallet"
	"github.com/Blockchaindevscol/beatschain/accounts/usbwallet"
	"github.com/Blockchaindevscol/beatschain/cmd/utils"
	"github.com/Blockchaindevscol/beatschain/eth/catalyst"
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "gbeats.ipc"
	return cfg
}

// makeConfigNode loads gbeats configuration and creates a blank node instance.
...
// makeFullNode loads gbeats configuration and creates the beats backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the beats Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
