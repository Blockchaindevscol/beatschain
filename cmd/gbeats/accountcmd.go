...
var (
	walletCommand = cli.Command{
		...
		Description: `
    gbeats wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gbeats wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gbeats account update [options] <address>
