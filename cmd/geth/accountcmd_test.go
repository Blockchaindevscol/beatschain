...
func TestAccountListEmpty(t *testing.T) {
	gbeats := runGeth(t, "account", "list")
	gbeats.ExpectExit()
}

func TestAccountList(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gbeats := runGeth(t, "account", "list", "--datadir", datadir)
	defer gbeats.ExpectExit()
...
func TestAccountNew(t *testing.T) {
	gbeats := runGeth(t, "account", "new", "--lightkdf")
	defer gbeats.ExpectExit()
	gbeats.Expect(`
...
func importAccountWithExpect(t *testing.T, key string, expected string) {
	...
	gbeats := runGeth(t, "account", "import", keyfile, "-password", passwordFile)
	defer gbeats.ExpectExit()
	gbeats.Expect(expected)
}
...
func TestAccountUpdate(t *testing.T) {
	datadir := tmpDatadirWithKeystore(t)
	gbeats := runGeth(t, "account", "update",
...
func TestWalletImport(t *testing.T) {
	gbeats := runGeth(t, "wallet", "import", "--lightkdf", "testdata/guswallet.json")
	defer gbeats.ExpectExit()
	gbeats.Expect(`
!! Unsupported terminal, password will be echoed.
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(gbeats.Datadir, "keystore"))
	if len(files) != 1 {
...
func TestUnlockFlag(t *testing.T) {
	gbeats := runMinimalGeth(t, "--port", "0", "--ipcdisable", "--datadir", tmpDatadirWithKeystore(t),
...
`)
	...
	for _, m := range wantMessages {
		if !strings.Contains(gbeats.StderrText(), m) {
...
// https://github.com/Blockchaindevscol/beatschain/issues/1785
...
func TestUnlockFlagAmbiguous(t *testing.T) {
	...
	gbeats.SetTemplateFunc("keypath", func(file string) string {
