...
var (
	snapshotCommand = cli.Command{
		...
		Subcommands: []cli.Command{
			{
				Name:      "prune-state",
				Usage:     "Prune stale Beats state data based on the snapshot",
				ArgsUsage: "<root>",
				...
				Description: `
gbeats snapshot prune-state <state-root>
...
`,
			},
			{
				...
				Description: `
gbeats snapshot verify-state <state-root>
...
`,
			},
			{
				...
				Description: `
gbeats snapshot traverse-state <state-root>
...
`,
			},
			{
				...
				Description: `
gbeats snapshot traverse-rawstate <state-root>
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'gbeats dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'gbeats dump', but uses the snapshots
