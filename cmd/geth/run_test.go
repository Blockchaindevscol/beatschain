...
import (
	...
	"github.com/Blockchaindevscol/beatschain/internal/cmdtest"
	"github.com/Blockchaindevscol/beatschain/rpc"
	"github.com/docker/docker/pkg/reexec"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gbeats-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gbeats-test" in runGeth.
	reexec.Register("gbeats-test", func() {
...
// spawns gbeats with the given command line args. If the args don't set --datadir, the
...
func runGeth(t *testing.T, args ...string) *testgeth {
	...
	// Boot "gbeats". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gbeats-test", args...)
