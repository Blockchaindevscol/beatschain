...
// setting up a new or managing an existing Beats private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Beats private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Beats network down to  |")
	...
	log.Info("Administering Beats network", "name", w.network)
