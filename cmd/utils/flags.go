...
import (
	...
	"github.com/Blockchaindevscol/beatschain/accounts"
	"github.com/Blockchaindevscol/beatschain/accounts/keystore"
	"github.com/Blockchaindevscol/beatschain/common"
	"github.com/Blockchaindevscol/beatschain/common/fdlimit"
	"github.com/Blockchaindevscol/beatschain/consensus"
	"github.com/Blockchaindevscol/beatschain/consensus/clique"
	"github.com/Blockchaindevscol/beatschain/consensus/ethash"
	"github.com/Blockchaindevscol/beatschain/core"
	"github.com/Blockchaindevscol/beatschain/core/rawdb"
	"github.com/Blockchaindevscol/beatschain/core/vm"
	"github.com/Blockchaindevscol/beatschain/crypto"
	"github.com/Blockchaindevscol/beatschain/eth"
	"github.com/Blockchaindevscol/beatschain/eth/downloader"
	"github.com/Blockchaindevscol/beatschain/eth/ethconfig"
	"github.com/Blockchaindevscol/beatschain/eth/gasprice"
	"github.com/Blockchaindevscol/beatschain/eth/tracers"
	"github.com/Blockchaindevscol/beatschain/ethdb"
	"github.com/Blockchaindevscol/beatschain/ethstats"
	"github.com/Blockchaindevscol/beatschain/graphql"
	"github.com/Blockchaindevscol/beatschain/internal/ethapi"
	"github.com/Blockchaindevscol/beatschain/internal/flags"
	"github.com/Blockchaindevscol/beatschain/les"
	"github.com/Blockchaindevscol/beatschain/log"
	"github.com/Blockchaindevscol/beatschain/metrics"
	"github.com/Blockchaindevscol/beatschain/metrics/exp"
	"github.com/Blockchaindevscol/beatschain/metrics/influxdb"
	"github.com/Blockchaindevscol/beatschain/miner"
	"github.com/Blockchaindevscol/beatschain/node"
	"github.com/Blockchaindevscol/beatschain/p2p"
	"github.com/Blockchaindevscol/beatschain/p2p/enode"
	"github.com/Blockchaindevscol/beatschain/p2p/nat"
	"github.com/Blockchaindevscol/beatschain/p2p/netutil"
...
func MakeDataDir(ctx *cli.Context) string {
	if path := ctx.GlobalString(DataDirFlag.Name); path != "" {
		if ctx.GlobalBool(RopstenFlag.Name) {
			// Maintain compatibility with older gbeatsconfigurations storing the
...
// for gbeatsand returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gbeats account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gbeats.", tagsMap)
		} else if enableExportV2 {
			tagsMap := SplitTagsFlag(ctx.GlobalString(MetricsInfluxDBTagsFlag.Name))

			log.Info("Enabling metrics export to InfluxDB (v2)")

			go influxdb.InfluxDBV2WithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, token, bucket, organization, "gbeats.", tagsMap)
		}
...
// new format.
//
// e.g. gbeats account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gbeats --keystore /tmp/mykeystore --lightkdf account new
//
