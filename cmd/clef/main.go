...
import (
	...
	"github.com/Blockchaindevscol/beatschain/signer/core"
	"github.com/Blockchaindevscol/beatschain/signer/core/apitypes"
	"github.com/Blockchaindevscol/beatschain/signer/fourbyte"
	"github.com/Blockchaindevscol/beatschain/signer/rules"
	"github.com/Blockchaindevscol/beatschain/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Beats account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/Blockchaindevscol/beatschain/issues/20123
