...
import (
	...
	"github.com/Blockchaindevscol/beatschain/internal/utesting"
...
func TestEthSuite(t *testing.T) {
	gbeats, err := runGeth()
	if err != nil {
		t.Fatalf("could not run gbeats: %v", err)
	}
	defer gbeats.Close()

	suite, err := NewSuite(gbeats.Server().Self(), fullchainFile, genesisFile)
	if err != nil {
...
// runGeth creates and starts a gbeats node
