...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbeats.ipc", false, filepath.Join(os.TempDir(), "gbeats.ipc")},
		{"data", "gbeats.ipc", false, "data/gbeats.ipc"},
		{"data", "./gbeats.ipc", false, "./gbeats.ipc"},
		{"data", "/gbeats.ipc", false, "/gbeats.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbeats.ipc", true, `\\.\pipe\gbeats.ipc`},
		{"data", "gbeats.ipc", true, `\\.\pipe\gbeats.ipc`},
		{"data", `\\.\pipe\gbeats.ipc`, true, `\\.\pipe\gbeats.ipc`},
	}
